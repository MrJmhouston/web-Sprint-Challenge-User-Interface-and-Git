...
block creates a new line, by default block takes up the entire width available.
-----------------------------------------------------------------------------
...
the vertical axis or X axis.
-----------------------------------------------------------------------------

5. Explain why git is valuable to a team of developers.

git allows a team all to work on the same project at the sametime while keeping track of everyones changes seperately. 
-----------------------------------------------------------------------------
